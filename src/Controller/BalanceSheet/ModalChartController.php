...
{
    #[Route('/fgp/{averageFgp}/{title}/{displayLabel}', name: 'fgp', methods: ['GET'], requirements: ['displayLabel' => '0|1'])]
    ...
    #[Route('/fgp/{averageNutrient}/{title}/{displayLabel}', name: 'nutrient', methods: ['GET'], requirements: ['displayLabel' => '0|1'])]
